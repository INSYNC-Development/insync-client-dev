...
// async function getAvailableSlots(customerId, startDate, days = 1) {
//   try {
//     const queryObj = {};

//     if (customerId) queryObj.customerId = customerId;
//     if (startDate) queryObj.slotWindowStartDate = startDate;
//     if (days) queryObj.daysAhead = days;

//     const queryParams = new URLSearchParams(queryObj).toString();

//     const response = await fetch(
//       `${API_URL}/appointments/bookable?${queryParams}`,
//       {
//         method: "GET",
//       }
//     );
...
//     if (!response.ok) {
//       throw new Error(data.message || "Gagal mengambil daftar slot");
//     }

//     return data;
//   } catch (error) {
//     console.error("Error Fetch Slots:", error.message);
//     return null;
//   }
// }
...
//       bookableAppointmentId: 1210118450,
//       startDateTime: startDateTime,
//       endDateTime: endDateTime,
//       instructorIds: instructorIds,
//     };

//     const response = await fetch(`${API_URL}/appointments/bookable`, {
//       method: "POST",
...
//         if (isPTChecked) {
//           const vertragsbeginn = formatISO(formData["Vertragsbeginn"]);
//           console.log("Tanggal pencarian (Vertragsbeginn):", vertragsbeginn);
...
//           let bookingDate = "Bitte manuell planen";
//           let bookingTime = "-";
...
//               return new Date(slot.startDateTime) >= tomorrowStart;
//             });

//             if (futureSlots.length > 0) {
//               const firstValidSlot = futureSlots[0];
//               console.log("Memilih jadwal:", firstValidSlot.startDateTime);

//               const slotDate = new Date(firstValidSlot.startDateTime);
//               bookingDate = slotDate.toLocaleDateString("de-DE", {
//                 weekday: "long",
//                 year: "numeric",
//                 month: "long",
//                 day: "numeric",
...
//               });
//               bookingTime = slotDate.toLocaleTimeString("de-DE", {
//                 hour: "2-digit",
//                 minute: "2-digit",
//                 timeZone: "Europe/Berlin",
//               });
...
//                 result.customerId,
//                 firstValidSlot.startDateTime,
//                 firstValidSlot.endDateTime,
//                 firstValidSlot.instructors.map((i) => i.id)
//               );
//             } else {
...
//           } else {
//             console.warn(
//               "⚠️ Keine Slots verfügbar (Sama sekali tidak ada slot)"
//             );
//           }

//           await sendEmailTrainer({
//             memberName: result.customerName,
//             memberNumber: result.customerNumber,
...
//   async function sendEmailTrainer({
//     memberName,
//     memberNumber,
//     bookingDate,
//     bookingTime,
//   }) {
//     try {
//       await emailjs.send("service_65w45jz", "template_t1pvv6j", {
