...
const lenis = new Lenis({
  ...
  function initLottie() {
    ...
    // 1. UPDATE: Gunakan pseudo-class :not(.u-loottie) untuk mengecualikan lottie dari Webflow
    ...
    lottieContainers.forEach((container) => {
      if (container.getAttribute("data-animation-type") === "lottie") {
        return;
      }
